...
const MOVES = {
  "4,6": { c: 4, r: 4, d: 0.9 }, // e2-e4
  "4,1": { c: 4, r: 3, d: 1.4 }, // e7-e5
  "6,7": { c: 5, r: 5, d: 1.9 }, // Ng1-f3
  "1,0": { c: 2, r: 2, d: 2.4 }, // Nb8-c6
};
            ...
            return (
              <span key={i} className={cls} style={style}>
                <span className="ch-lift">
                  <span className="ch-pi" style={{ animationDelay: `${(0.15 + p.r * 0.035 + p.c * 0.008).toFixed(3)}s` }}>
                    <Piece type={p.t} />
                  </span>
                </span>
              </span>
