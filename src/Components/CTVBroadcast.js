...
export default function CTVBroadcast() {
  const tickerText =
    "WOMEN'S BJJ CLASS • SATURDAY DECEMBER 20, 2025 • 12:00 PM • LED BY NABIHA SHAIKH & JESSICA CHABERSKI • MAPLE JIU-JITSU • WOMEN ONLY • ALL LEVELS WELCOME • LIMITED SPOTS • DM TO REGISTER • ";
